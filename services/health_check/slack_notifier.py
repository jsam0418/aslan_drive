...
class SlackNotifier:
    ...
    def __init__(self, webhook_url: Optional[str] = None):
        ...
        if not self.webhook_url:
            logger.warning("No Slack webhook URL provided. Notifications will be logged only.")
        else:
    ...
    async def send_health_check_success(self, 
                                      check_date: str, 
                                      records_found: int,
                                      symbols: list,
                                      database_stats: Optional[Dict[str, Any]] = None) -> bool:
    ...
    async def send_health_check_failure(self, 
                                      check_date: str, 
                                      error_message: str,
                                      database_connected: bool = False) -> bool:
    ...
    async def send_data_ingestion_complete(self, 
    ...
    async def send_system_startup(self, service_name: str, version: str = "0.1.0") -> bool:
