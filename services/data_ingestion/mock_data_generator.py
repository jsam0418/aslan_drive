...
class MockOHLCVGenerator:
    ...
    def generate_daily_ohlcv(self, symbol: str, trade_date: date) -> Dict[str, Any]:
        ...
        base_volume = {
            "AAPL": 50_000_000, "GOOGL": 25_000_000, "MSFT": 30_000_000,
            "TSLA": 75_000_000, "AMZN": 35_000_000, "NVDA": 45_000_000,
            "META": 20_000_000, "NFLX": 8_000_000, "SPY": 80_000_000, "QQQ": 40_000_000
        }
    ...
    def generate_historical_data(self, 
        ...
        logger.info(f"Generating mock data for {len(symbols)} symbols from {start_date} to {end_date}")
    ...
    def generate_symbols_metadata(self) -> List[Dict[str, Any]]:
        ...
        metadata = [
            {"symbol": "AAPL", "name": "Apple Inc.", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "GOOGL", "name": "Alphabet Inc.", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "MSFT", "name": "Microsoft Corporation", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "TSLA", "name": "Tesla, Inc.", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "AMZN", "name": "Amazon.com, Inc.", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "NVDA", "name": "NVIDIA Corporation", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "META", "name": "Meta Platforms, Inc.", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "NFLX", "name": "Netflix, Inc.", "asset_class": "equity", "exchange": "NASDAQ", "currency": "USD", "active": True},
            {"symbol": "SPY", "name": "SPDR S&P 500 ETF Trust", "asset_class": "etf", "exchange": "NYSE", "currency": "USD", "active": True},
            {"symbol": "QQQ", "name": "Invesco QQQ Trust", "asset_class": "etf", "exchange": "NASDAQ", "currency": "USD", "active": True},
        ]
